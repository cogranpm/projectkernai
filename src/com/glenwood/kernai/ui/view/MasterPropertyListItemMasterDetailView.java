...
public class MasterPropertyListItemMasterDetailView extends BaseEntityMasterDetailListModalView<MasterPropertyListItem, MasterProperty> {
	...
	@Override
	protected void setupModelAndPresenter(MasterProperty parentEntity) {
		this.model = new MasterPropertyListItemViewModel(parentEntity);
		this.presenter = new MasterPropertyListItemViewPresenter(this, (MasterPropertyListItemViewModel)this.model);
	}
	...
	public void showAddEdit(Boolean adding) {
		super.showAddEdit(adding);
		MasterPropertyListItemModalView modalView = new MasterPropertyListItemModalView(getShell());
		modalView.setModel((MasterPropertyListItemViewModel) model);
	...
	public void refreshView() {
		super.refreshView();
		input = new WritableList(model.getItems(), MasterPropertyListItem.class);
	...
	protected void initDataBindings() {
        ...
        IObservableSet<MasterPropertyListItem> detailElements = detailContentProvider.getKnownElements();
        final IObservableMap keys = BeanProperties.value(MasterPropertyListItem.class, "key").observeDetail(detailElements);
        final IObservableMap<String, String> labels = BeanProperties.value(MasterPropertyListItem.class, "label").observeDetail(detailElements);
        ...
        ILabelProvider detailLabelProvider = new ObservableMapLabelProvider(detailLabelMaps) {
                ...
                public String getColumnText(Object element, int columnIndex) {
                	MasterPropertyListItem mc = (MasterPropertyListItem)element;
                	switch(columnIndex)
                	{
                	case 0:
                		return mc.getKey();
	...
	private class ViewerComparator extends ListSorterHelper
	{
		...
		public int compare(Viewer viewer, Object e1, Object e2) {
			...
			MasterPropertyListItem p1 = (MasterPropertyListItem)e1;
			MasterPropertyListItem p2 = (MasterPropertyListItem)e2;
			int rc = 0;
